<? View::show('main/elements/div_top'); ?><? if (isset($user) && $user && $pageinfo['mname'] != 'index') :
	View::show($user->user_group.'/elements/div_header');
	elseif (isset($user) && $user && $pageinfo['mname'] == 'index') : ?><div class='top-block'>
...
</div><? elseif ($pageinfo['mname'] == 'index') : ?><div class='top-block'>
	<? if (isset($filter)) View::show('main/elements/order_filter'); ?>
