			...
			<form id="pagerForm" class='admin-inside' action="<?=$selfurl?>updateWeight" method="POST">
				<ul class='tabs'>
					...
					<table>
						...
						<tr>
							...
							<td nowrap>
								...
								<? if ($package->package_cost < $package->package_cost_payed) : ?>: $<?=$package->package_manager_cost?>
								<br />
								<div class='float'>	
							...
							<td align="center">
								<b><?=$package->package_trackingno?></b>
								<br />
