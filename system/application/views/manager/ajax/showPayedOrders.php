			...
			<table>
				...
				<tr id="order<?=$order->order_id?>" >
					...
					<? switch ($order->order_status) {
						...
						<? endif; ?>
						<? if ($order->order_cost > $order->order_cost_payed) : ?><br />$<?=$order->order_cost_payed - $order->order_system_comission_payed?>
						<br />Доплатить $<?=$order->order_manager_cost - $order->order_cost_payed + $order->order_system_comission_payed?>
						<? endif; ?>
						<br />
