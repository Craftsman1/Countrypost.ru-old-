			...
			<form class='admin-inside' id="packagesForm" action="<?=$selfurl?>updatePayedPackagesStatus" method="POST">
				<ul class='tabs'>
					...
					<table>
						...
						<tr>
							...
							<td align="center">
								...
								<br />Доплатить $<?=$package->package_cost - $package->package_cost_payed?>
								<? endif; ?>
								<br />
								...
								<? endif; ?>
								<hr />
								<a href="javascript:deleteItem('<?=$package->package_id?>');" class='delete'><img title="Удалить" border="0" src="/static/images/delete.png"></a></td>
						</tr>
						<?endforeach; endif;?>
						<tr class='last-row'>
							<td colspan='10'>
