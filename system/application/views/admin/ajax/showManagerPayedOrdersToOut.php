	...
	<form id="pagerForm" class='admin-inside' action='<?=$selfurl?>saveOrders2out/showManagerPayedOrdersToOut' method="POST">
		<ul class='tabs'>
			<li><div><a href='<?=$selfurl?>showManagerOrdersToOut'>Новые</a></div></li>
			<li class='active'><div><a href='<?=$selfurl?>showManagerPayedOrdersToOut'>Выплаченные</a></div></li>
		</ul>
