<div class='content'>
	...
	<h3>Закрытые заявки на вывод (клиенты)</h3>
	<div class='back'>
		<a class='back' href='javascript:history.back();'><span>Назад</span></a>
	</div>
	<form class='admin-sorting' id="filterForm" action="<?=$selfurl?>filterPayedClientO2o" method="POST">
	...
	<?View::show($viewpath.'ajax/showClientPayedOrdersToOut', array(
				'Orders'	=> $Orders,
