<form method="POST" action="https://merchant.webmoney.ru/lmi/payment.asp" name="postform">
	...
	LMI_PAYMENT_DESC:<input type="text" name="LMI_PAYMENT_DESC" value="Refill balance for client <?=$user->user_id?> on <?=$amount?> RUR ($<?=$amount_usd?>)"><br />
	...
	User_comment:<input type="text" name="User_comment" value=""><br />
